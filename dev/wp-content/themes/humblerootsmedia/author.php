          ...
          if( $query->max_num_pages > 1 ) : ?>
              ...
              if($paged != 1) : ?>
                <div class="pager-col">
                  ...
                  <a class="pager-link" href="/author/<?php echo $author->user_nicename;?>/page/<?php echo ($paged - 1); ?>"><i class="fa fa-fw fa-angle-left"></i> Newer</a>
                </div>
              <?php endif;

              if($paged != $query->max_num_pages) : ?>
                <div class="pager-col">
                  <a class="pager-link" href="/author/<?php echo $author->user_nicename; ?>/page/<?php echo ($paged + 1); ?>">Older <i class="fa fa-fw fa-angle-right"></i></a>
